...
@ParentPackage("dawi")
public class TelevisorAction extends ActionSupport{
	
	private Televisor[] listaTelevisor; 
	...
	@Action(value="/listaTelevisorXStock", results= {@Result(name="ok",type="json")})
	public String listaTelevisorXStock() throws ClientProtocolException, IOException {
		HttpGet http=new HttpGet(REST_TELEVISOR+"consulta/"+cantidad1+"/"+cantidad2);
		HttpResponse response=httpClient.execute(http);
		//
		String json=EntityUtils.toString(response.getEntity());
		//
		Gson gson=new Gson();
		listaTelevisor=gson.fromJson(json, Televisor[].class);
		return "ok";
	}
	...
	public Televisor[] getListaTelevisor() {
		return listaTelevisor;
	}

	public void setListaTelevisor(Televisor[] listaTelevisor) {
